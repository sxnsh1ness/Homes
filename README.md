...
- ✅ Система приглашений
- ✅ GUI меню для управления домами
- ✅ Красивые эффекты пламени во время ожидания телепортации
...
|--------------------------------|--------------|----------|
| `/homegui`                     | `/homesgui`  | Открыть GUI меню управления домами |
| `/sethome <название>`          | -            | Создать или обновить точку дома |
| `/home <название>`             | -            | Телепортироваться на точку дома |
| `/deletehome <название>`       | `/delhome`   | Удалить точку дома |
| `/renamehome <старое> <новое>` | -            | Переименовать точку дома |
| `/homes`                       | `/listhomes` | Показать список всех ваших домов |
...
| `/home teleport <игрок> <дом>` | `homes.admin` | Телепортироваться к дому игрока |

Административные команды позволяют:
- Просматривать список всех домов любого игрока
- Видеть координаты и количество приглашённых игроков
