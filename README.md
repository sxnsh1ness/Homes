...
| `/homes`                       | -          | Открыть GUI-меню управления домами |
...
|-------------------------------|---------------|----------|
| `/listhomes <игрок>`          | `homes.admin` | Посмотреть все дома игрока |
| `/teleporthome <игрок> <дом>` | `homes.admin` | Телепортироваться к дому игрока |
